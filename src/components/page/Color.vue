				...
				<el-form :label-position="labelPosition" label-width="80px" :model="formLabelAdd">
					...
					<el-form-item label="产品">
						<el-select v-model="formLabelAdd.productId" placeholder="请选择产品" filterable>
							...
							<el-pagination @size-change="changeSize3" @current-change="changePage3" :current-page="page3" :page-sizes="[10, 20]"
							 :page-size="10" layout="total, sizes, prev, pager, next, jumper" :total="totalNum3"></el-pagination>
						</el-select>
					</el-form-item>
					...
					<el-form-item label="图片">
						<el-upload class="upload-demo" action="management/admin/kcupload!uploadImage.action" :data="imgData1" :on-preview="handlePreview"
						 :on-remove="handleRemove1" :on-success="handleSuccess1" :file-list="fileList1" :before-upload="beforeUpload1"
						 list-type="picture">
		...
		<el-table :data="colorList" border style="width: 100%">
			...
			<el-table-column label="操作" align="center">
				<template slot-scope="scope">
					<el-button @click.native.prevent="deleteRow(scope.$index, colorList)" type="danger" size="small" class="el-icon-delete"
					 v-del>删除</el-button>
						...
						<el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
							...
							<el-form-item label="产品">
								<el-select v-model="formLabelAlign.name" placeholder="请选择产品" filterable>
									<el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id"></el-option>
									<el-pagination @size-change="changeSize2" @current-change="changePage2" :current-page="page2" :page-sizes="[10, 20]"
									 :page-size="10" layout="total, sizes, prev, pager, next, jumper" :total="totalNum2"></el-pagination>
								</el-select>
							</el-form-item>
							<el-form-item label="色号名称">
