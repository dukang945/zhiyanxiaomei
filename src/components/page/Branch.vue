<template>
	<div>
		<div class="handle-box">
			...
			<el-dialog title="新增" :visible.sync="AddVisible" width="30%" :before-close="handleClose" v-has>
				<el-form :label-position="labelPosition" label-width="80px" :model="formLabelAdd">
					...
					<el-form-item label="产品分类">
						<el-cascader :options="treeData" change-on-select :show-all-levels="false" @active-item-change="handleItemChange"
						 expand-trigger="hover" :props="props" v-model="formLabelAdd.categoryId"></el-cascader>
					</el-form-item>
		...
		<el-tabs v-model="activeName" @tab-click="handleClick">
			<el-tab-pane :label="item.name" :name="item.id.toString()" v-for="(item) in mainList" :key="item.name">
				<el-table :data="branchList" border style="width: 100%">
					...
					<el-table-column label="操作" align="center">
						<template slot-scope="scope">
							<el-button @click.native.prevent="deleteRow(scope.$index, branchList)" type="danger" size="small" class="el-icon-delete"
							 v-del>删除</el-button>
							<el-button size="small" type="primary" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)" v-has>编辑</el-button>
							<el-dialog title="编辑" :visible.sync="dialogVisible" width="30%" :before-close="handleClose" append-to-body>
								<el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
									...
									<el-form-item label="产品分类">
										<el-cascader :options="treeData" change-on-select :show-all-levels="false" @active-item-change="handleItemChange"
										 expand-trigger="hover" :props="props" v-model="selectOptions"></el-cascader>
									</el-form-item>
									<el-form-item label="步骤数">
